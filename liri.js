...
function concert(option, value){
 if (option === "concert-this"){
        ...
        axios.get(concertUrl).then(
            function (response) {
               // console.log("There are total of " + response.data.length + " events found for the artist " + value);
...
function spotify_this(option, value){
...
function movie_this(option, value){
...
if (pickOption === "concert-this") {
    ...
    if (artistStr === "" || !(artistStr)) {
        ...
        // call concert
        concert("concert-this",artistStr );
    ...
    // Call Spotify
    spotify_this("spotify-this-song", songs);
    ...
    //console.log(" you have selected the pick option as " + pickOption);
    // call movie_this
    movie_this("movie-this", movieStr);
   ...
   // console.log(" you have selected the pick option as " + pickOption);
    ...
    fs.readFile("random.txt", "utf8", function (error, data) {
        ...
        if (dataArr[0] === "movie-this") {
            movie_this("movie-this", dataArr[1]);
        } 
        else if (dataArr[0] === "spotify-this-song"){
            spotify_this("spotify-this-song", dataArr[1]);

        }
        else if (dataArr[0] ==="concert-this") {
            concert("concert-this",dataArr[1] );
        }
        else {
            console.log("Incorrect choice provided. ");
        }
